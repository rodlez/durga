    ...
    <div class="container bg-light">
        ...
        <form method="POST" class="contacto-form p-4">
            ...
            <div class="row bg-light justify-content-center p-4 mb-5">
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <input type="text" class="form-control border-2" id="title" name="title" value="<?php echo ($oldFormData['title'] ?? ''); ?>" maxlength="50">
                </div>
                <!-- Error Message -->
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <input type="text" class="form-control border-2" id="title" name="subtitle" value="<?php echo ($oldFormData['subtitle'] ?? ''); ?>" maxlength="50">
                </div>
                <!-- Error Message -->
