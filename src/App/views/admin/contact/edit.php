        ...
        <form method="POST" class="contacto-form p-4">
            ...
            <div class="row bg-light justify-content-center p-4 mb-5">
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <input value="<?php echo $contact->formatted_date ?>" name="date" type="date" class="form-control" />
                </div>
                <!-- Error Message -->
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <select name="status" id="status" class="form-control">
                        <option value="0" <?php echo ($contact->status === 0) ? "selected" : "" ?>>No</option>
                        <option value="1" <?php echo ($contact->status === 1) ? "selected" : "" ?>>Yes</option>
                    </select>
                </div>
                <!-- NAME -->
                <div class="col-lg-2 bg-warning text-light text-uppercase fw-400 my-2 p-2 rounded">
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <input type="text" class="form-control border-2" id="name" name="name" value="<?php echo $contact->name; ?>" maxlength="50">
                </div>
                <!-- Error Message -->
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <input type="email" class="form-control border-2" id="email" name="email" value="<?php echo $contact->email; ?>" maxlength="50">
                </div>
                <!-- Error Message -->
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $contact->phone; ?>" maxlength="9">
                </div>
                <!-- Error Message -->
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <select name="subject" id="subject" class="form-control">
                        <option value="Pedir Cita" <?php echo ($contact->subject === 'Pedir Cita') ? 'selected' : ''; ?>>Pedir Cita</option>
                        <option value="Contratar Sesión" <?php echo ($contact->subject === 'Contratar Sesión') ? 'selected' : ''; ?>>Contratar Sesión</option>
                        <option value="Sesión de Exploración" <?php echo ($contact->subject === 'Sesión de Exploración') ? 'selected' : ''; ?>>Sesión de Exploración</option>
                        <option value="Otra Consulta" <?php echo ($contact->subject === 'Otra Consulta') ? 'selected' : ''; ?>>Otra Consulta</option>
                    </select>
                </div>
                <!-- Error Message -->
                ...
                <div class="col-lg-8 offset-lg-1 bg-info text-primary my-2 p-2 rounded">
                    <textarea name="message" rows="4" cols="50" class="w-100 rounded"><?php echo $contact->message; ?></textarea>
                </div>
                <!-- Error Message -->
